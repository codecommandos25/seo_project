...
const chartData = [
    { date: "2025-04-01", organic: 222, paid: 150 },
    { date: "2025-04-02", organic: 97, paid: 180 },
    { date: "2025-04-03", organic: 167, paid: 120 },
    { date: "2025-04-04", organic: 242, paid: 260 },
    { date: "2025-04-05", organic: 373, paid: 290 },
    { date: "2025-04-06", organic: 301, paid: 340 },
    { date: "2025-04-07", organic: 245, paid: 180 },
    { date: "2025-04-08", organic: 409, paid: 320 },
    { date: "2025-04-09", organic: 59, paid: 110 },
    { date: "2025-04-10", organic: 261, paid: 190 },
    { date: "2025-04-11", organic: 327, paid: 350 },
    { date: "2025-04-12", organic: 292, paid: 210 },
...
export function TrafficSection() {
    ...
    const total = React.useMemo(
        () => ({
            organic: filteredData.reduce((acc, curr) => acc + curr.organic, 0),
            paid: filteredData.reduce((acc, curr) => acc + curr.paid, 0),
        }),
        [filteredData]
    )
    ...
    return (
        <Card>
            ...
            <div className="flex justify-end px-6 py-4">
                <Select value={timeRange} onValueChange={(value) => setTimeRange(value as "1y" | "6m" | "30d")}>
