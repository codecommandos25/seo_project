    ...
    <Card>
      <CardHeader className='flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row'>
        <div className='flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6'>
          <CardTitle>Website Backlinks</CardTitle>
          <CardDescription>
        ...
        <Tabs defaultValue='top-anchor' className='w-full'>
          <div className='w-full overflow-x-auto py-4 sm:py-0'>
            <TabsList>
              ...
              <TabsTrigger value='referring-domain'>
                Referring Domains
              </TabsTrigger>
            </TabsList>
          </div>
                ...
                <TableBody>
                  {topanchorData.map((anchor: any, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell>{anchor.rank}</TableCell>
                      <TableCell>
                        {anchor.referring_links_platform_types.unknown}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        {new Intl.DateTimeFormat('en-US', {
                          month: 'short',
                          year: 'numeric',
                        }).format(new Date(domain.first_seen))}
                      </TableCell>
