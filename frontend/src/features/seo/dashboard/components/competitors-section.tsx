                    ...
                    <Table>
                        ...
                        <TableBody>
                            {competitorsData.map((competitor, index) => (
                                <TableRow key={index}>
                                    <TableCell className="font-medium">{competitor.competitorWebsite}</TableCell>
                                    <TableCell>{competitor.domainAuthority}</TableCell>
                                    <TableCell>{competitor.organicTraffic}</TableCell>
                                    <TableCell>{competitor.totalBacklinks}</TableCell>
                                    <TableCell>{competitor.referringDomains}</TableCell>
