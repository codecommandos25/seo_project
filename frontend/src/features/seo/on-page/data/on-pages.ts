...
import { onPageAnalysis } from './schema' // Assuming your schema is in a separate file

export const onPagesAnalysis: onPageAnalysis[] = Array.from({ length: 20 }, () => {
  ...
  return {
    ...
    description: faker.helpers.maybe(() => faker.lorem.sentence(10), { probability: 0.9 }) || null,
    imageCount: faker.number.int({ min: 0, max: 15 }),
    h1: faker.helpers.maybe(() => faker.lorem.sentence(4), { probability: 0.95 }) || null,
    h2Tags,
