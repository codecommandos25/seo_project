    ...
    return (
        ...
        <>
            ...
            <Main>
                ...
                <div className="grid grid-cols-3 gap-2 p-2 bg-light-blue">
                    <ImageDiv />
                    <Subsection sectionName="Performance Summary" className="col-span-2 max-h-[300px]">
                        <div className="flex items-center gap-4 justify-evenly h-[90%]">
                    ...
                    <Subsection sectionName="Recommendations" className="col-span-3">
                        <div className="flex items-center gap-10 p-2 px-4 bg-light-blue rounded-t-lg mt-4">
