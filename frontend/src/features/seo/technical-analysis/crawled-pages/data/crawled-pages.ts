...
export const crawledPages = Array.from({ length: 20 }, () => {
  return {
    ...
    hreflangUsage: faker.helpers.maybe(
      () =>
    ...
    canonicalUrl: faker.helpers.maybe(() => faker.internet.url(), {
      probability: 0.8,
    }),
