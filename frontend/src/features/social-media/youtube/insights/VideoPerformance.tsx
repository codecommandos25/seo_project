...
export default function VideoPerformance({ videoId }: VideoPerformanceProps) {
  ...
  const formattedRetentionData = data.audienceRetention.map(
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value='overview' className='space-y-4'>
            ...
            <div className='mt-6 h-64'>
              <p className='mb-2 font-medium'>Views Trend</p>
          ...
          <TabsContent value='retention' className='space-y-4'>
            <div className='rounded-md bg-muted p-4'>
              ...
              <p className='text-sm text-muted-foreground'>
                Videos with retention higher than 50% typically perform well in
                recommendations.
              </p>
            </div>
            ...
            <div className='mt-4 grid grid-cols-1 gap-4 md:grid-cols-2'>
                ...
                <ul className='space-y-1 text-sm'>
                  ...
                  {data.audienceRetention.length > 3 && (
                    <>
                      <li>
                        •{' '}
                        {data.audienceRetention[2].retentionPercentage -
                          data.audienceRetention[1].retentionPercentage >
                        -8
                      ...
                      <li>
                        ...
                        {data.audienceRetention[
                          data.audienceRetention.length - 2
              ...
              <div className='space-y-2'>
                ...
                <ul className='space-y-1 text-sm'>
                  <li>
                    •{' '}
                    {data.audienceRetention[1].retentionPercentage < 80
                  ...
                  <li>
                    •{' '}
                    {data.audienceRetention[
                      Math.floor(data.audienceRetention.length / 2)
                  ...
                  <li>
                    •{' '}
                    {data.audienceRetention[data.audienceRetention.length - 1]
            ...
            <div className='mt-4 grid grid-cols-1 gap-4 md:grid-cols-3'>
              {data.trafficSources.map((source) => (
                ...
                >
                  ...
                  <p className='mt-1 text-sm text-muted-foreground'>views</p>
                </div>
              ))}
            </div>

            <div className='mt-4 rounded-md bg-muted p-4'>
              <h4 className='mb-2 font-medium'>Traffic Insights</h4>
              <ul className='space-y-1 text-sm'>
                <li>
                  • {data.trafficSources[0].source} is your top traffic source (
                  {data.trafficSources[0].percentage}%)
                </li>
                <li>
                  •{' '}
                  {data.ctr > 6
                    ...
                    : data.ctr > 4
                      ? 'Average'
                      : 'Below average'}{' '}
                  click-through rate of {data.ctr}%
                </li>
                <li>
                  • {data.recommendationImpressions.toLocaleString()}{' '}
                  impressions from recommendations
                </li>
                <li>
                  • Optimize for{' '}
                  {data.trafficSources[0].percentage > 30
                    ? data.trafficSources[0].source
                    : 'Browse features'}{' '}
                  to maximize growth
                </li>
              </ul>
          ...
          <TabsContent value='audience' className='space-y-4'>
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
              <div>
                <h4 className='mb-3 font-medium'>Viewer Demographics</h4>
                ...
                <h4 className='mb-3 mt-6 font-medium'>Engagement Metrics</h4>
                <div className='grid grid-cols-2 gap-4'>
              ...
              <div>
                <h4 className='mb-3 font-medium'>Performance Comparison</h4>
                  ...
                  <div className='space-y-1'>
                    ...
                    <div className='h-1.5 overflow-hidden rounded bg-muted'>
                      <div
                        ...
                        style={{
                          width: `${Math.min(100, data.performanceScore * 1.2)}%`,
                        }}
                      />
                    </div>
                  </div>
                ...
                <h4 className='mb-2 mt-6 font-medium'>Key Takeaways</h4>
                <ul className='space-y-1.5 text-sm'>
                  ...
                  <li>
                    • {data.subscribersGained > 100 ? 'Strong' : 'Average'}{' '}
                    subscriber conversion
                  </li>
                  <li>
                    • {data.ctr > 5 ? 'Effective' : 'Could improve'} thumbnail &
                    title
                  </li>
                  <li>
                    •{' '}
                    {data.retentionRate > 50 ? 'Good' : 'Needs improvement on'}{' '}
                    audience retention
                  </li>
                </ul>
              </div>
