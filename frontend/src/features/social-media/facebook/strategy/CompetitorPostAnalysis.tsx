  ...
  return [
    {
      ...
      competitorAvatar:
        'https://ui-avatars.com/api/?name=Digital+Marketing+Pro&background=0D8ABC&color=fff',
      content:
        'Want to improve your Facebook marketing strategy? Our new guide covers everything from organic posting to advanced ad targeting. Download it for free today!',
      imageUrl:
    ...
    },
    {
      ...
      competitorAvatar:
        'https://ui-avatars.com/api/?name=SEO+Masters&background=4CAF50&color=fff',
      content:
        'Breaking News: Major Google algorithm update rolling out now! Here is what we are seeing so far and how it might impact your rankings. #SEO #GoogleUpdate',
      imageUrl: null,
      likes: 328,
      comments: 94,
      shares: 215,
    ...
    },
    {
      ...
      competitorAvatar:
        'https://ui-avatars.com/api/?name=Growth+Hackers&background=FF5722&color=fff',
      content:
        'We helped this SaaS startup increase conversions by 136% in just 45 days. Swipe to see the exact strategies we used! #GrowthHacking #CaseStudy',
      imageUrl:
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Analyze high-engagement content from your competitors to inform your
          strategy
        </CardDescription>
      </CardHeader>
      <CardContent className='space-y-6'>
        {posts?.map((post) => (
          <div key={post.id} className='space-y-4 rounded-md border p-4'>
            {/* Competitor info */}
            <div className='flex items-center gap-3'>
              <Avatar>
                <AvatarImage src={post.competitorAvatar} />
                <AvatarFallback>
                  {post.competitorName.substring(0, 2)}
                </AvatarFallback>
              </Avatar>
              <div>
            ...
            <div className='rounded-md bg-muted/50 p-3'>
              <div className='mb-2 text-xs font-medium'>Why this works:</div>
              <ul className='space-y-1 text-xs'>
                {post.insights.map((insight, i) => (
                  <li key={i} className='flex items-start gap-2'>
                    <ArrowRight className='mt-0.5 h-3 w-3 text-blue-500' />
                    {insight}
                  </li>
                ))}
              </ul>
