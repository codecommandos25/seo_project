...
export default function AIContentIdeas() {
    ...
    return (
        <Card>
            ...
            <CardContent>
                <Tabs value={activeType} onValueChange={(value) => setActiveType(value as 'carousel' | 'reels' | 'post')}>
                                    ...
                                    <Card key={idea.id} className="overflow-hidden">
                                        <CardHeader className="py-3">
                                            ...
                                            <CardDescription className="text-xs">
                                                Type: {idea.type.charAt(0).toUpperCase() + idea.type.slice(1)}
                                            </CardDescription>
                                        </CardHeader>
