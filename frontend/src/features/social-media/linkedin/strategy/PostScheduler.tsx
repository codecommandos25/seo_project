...
export default function PostScheduler() {
  ...
  const [mediaType, setMediaType] = useState<'text' | 'image' | 'article'>(
    'text'
  )
  const [scheduledPosts, setScheduledPosts] = useState<ScheduledPost[]>([
    {
      id: '1',
      content:
        'Excited to announce our latest product feature launch! #ProductLaunch #Innovation',
    ...
    },
    {
      id: '2',
      content:
        "Join me next week for a webinar on 'The Future of Digital Marketing' where we'll discuss emerging trends and strategies.",
        ...
        <Tabs defaultValue='compose'>
          ...
          <TabsContent value='compose' className='space-y-4'>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
                ...
                {mediaType !== 'text' && (
                  <div className='flex cursor-pointer items-center justify-center rounded-md border-2 border-dashed p-4 hover:bg-muted/50'>
                ...
                .map((post) => (
                  ...
                  >
                    <div className='flex items-start justify-between'>
                      <div className='flex items-center gap-2'>
                        ...
                        <span className='text-sm font-medium'>
                          {format(post.scheduledFor, 'PPP')} at{' '}
                          {format(post.scheduledFor, 'p')}
                        </span>
                      </div>
                    ...
                    <div className='flex justify-end gap-2'>
                      ...
                      >
                        <Rocket className='mr-1 h-3 w-3' /> Publish now
                      </Button>
                    </div>
                  </div>
                ))}
          ...
          <TabsContent value='drafts'>
            <div className='space-y-4'>
              ...
              {scheduledPosts.filter((post) => post.status === 'draft')
                .length === 0 && (
                <div className='py-8 text-center text-muted-foreground'>
