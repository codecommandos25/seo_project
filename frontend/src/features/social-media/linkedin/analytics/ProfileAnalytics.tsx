        ...
        <CardContent className='space-y-6'>
                ...
                <div className='flex items-start justify-between'>
                  <div className='space-y-1'>
                    ...
                    <h3 className='text-2xl font-bold'>
                      {personal.followers.toLocaleString()}
                    </h3>
                    <div className='text-sm'>
                      {formatGrowth(personal.monthlyGrowth.toFixed(2))} this
                      month
                    </div>
                  </div>
              ...
              <CardContent className='p-6'>
                <div className='flex items-start justify-between'>
                  <div className='space-y-1'>
                    ...
                    <h3 className='text-2xl font-bold'>
                      {personal.profileViews.toLocaleString()}
                    </h3>
              ...
              <CardContent className='p-6'>
                <div className='flex items-start justify-between'>
                  <div className='space-y-1'>
                    ...
                    <h3 className='text-2xl font-bold'>
                      {personal.searchAppearances.toLocaleString()}
                    </h3>
                    <div className='text-sm text-muted-foreground'>
                      Last 30 days
                    </div>
              ...
              <CardContent className='p-6'>
                <div className='flex items-start justify-between'>
                  <div className='space-y-1'>
                    ...
                    <h3 className='text-2xl font-bold'>
                      {personal.postImpressions.toLocaleString()}
                    </h3>
                    <div className='text-sm text-muted-foreground'>
                      Last 30 days
                    </div>
          ...
          <Card>
            <CardHeader className='pb-2'>
              ...
              <CardDescription>
                Daily views over the past 30 days
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
            ...
            <Card>
              <CardHeader className='pb-2'>
                ...
                <CardDescription>
                  Based on your profile endorsements
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div key={index} className='space-y-1'>
                      ...
                      <Progress
                        value={
                          (skill.count /
                            Math.max(
                              ...personal.skillEndorsements.map((s) => s.count)
                            )) *
                          100
                        }
                        className='h-2'
