  ...
  if (error) {
    return (
      <Alert variant='destructive'>
        ...
        <AlertDescription>
          Failed to load LinkedIn company page analytics. Please try again
          later.
        </AlertDescription>
      </Alert>
    )
        ...
        <CardContent className='space-y-6'>
              ...
              <CardContent className='p-6'>
                <div className='flex items-start justify-between'>
                  <div className='space-y-1'>
                    ...
                    <h3 className='text-2xl font-bold'>
                      {company.postEngagementRate.toFixed(2)}%
                    </h3>
                    <div className='text-sm text-muted-foreground'>
              ...
              <CardContent className='p-6'>
                <div className='flex items-start justify-between'>
                  <div className='space-y-1'>
                    ...
                    <h3 className='text-2xl font-bold'>
                      {company.ctaClicks.toLocaleString()}
                    </h3>
                    <div className='text-sm text-muted-foreground'>
          ...
          <Card>
            <CardHeader className='pb-2'>
              ...
              <CardDescription>
                Monthly follower count over the past 6 months
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className='border-blue-200 bg-slate-50'>
            <CardHeader className='pb-2'>
              ...
              <CardDescription>
                Key insights based on your page data
              </CardDescription>
            </CardHeader>
            <CardContent>
