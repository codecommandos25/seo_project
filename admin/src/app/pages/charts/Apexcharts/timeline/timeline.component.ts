...
export class TimelineComponent implements OnInit {
  ...
  ngOnInit(): void {
     ...
     * BreadCrumb
     */
    this.breadCrumbItems = [{ label: 'Apexcharts' }, { label: 'Timeline Charts', active: true }];

    // Chart Color Data Get Function
    this._basicTimelineChart('["--vz-primary"]');
    this._differentColorChart(
      '["--vz-primary", "--vz-danger", "--vz-success", "--vz-warning", "--vz-info"]'
    );
    ...
    this._multipleSeriesChart(
      '["--vz-primary", "--vz-success", "--vz-warning", "--vz-danger", "--vz-info","--vz-gray","--vz-pink","--vz-purple","--vz-secondary", "--vz-body-color"]'
    );
